...
// Source: internal/identity/ports/login.go
//
// Generated by this command:
//
//	mockgen -source=internal/identity/ports/login.go -destination=internal/testkit/mocks/mock_identity_login.go -package=mocks
//
...
func (m *MockLoginUseCase) Login(ctx context.Context, email, password string) (*domain.UserToken, error) {
	m.ctrl.T.Helper()
