...
// Source: internal/publishing/ports/post.go
//
// Generated by this command:
//
//	mockgen -source=internal/publishing/ports/post.go -destination=internal/testkit/mocks/mock_publishing_post.go -package=mocks
//
