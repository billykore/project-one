...
// Source: internal/identity/ports/user.go
//
// Generated by this command:
//
//	mockgen -source=internal/identity/ports/user.go -destination=internal/testkit/mocks/mock_identity_user.go -package=mocks
//
...
func (mr *MockUserUseCaseMockRecorder) ChangePassword(ctx, userID, oldPassword, newPassword any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
