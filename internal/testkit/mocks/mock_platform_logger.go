...
// Source: internal/platform/ports/logger.go
//
// Generated by this command:
//
//	mockgen -source=internal/platform/ports/logger.go -destination=internal/testkit/mocks/mock_platform_logger.go -package=mocks
//
