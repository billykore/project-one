...
// Source: internal/publishing/ports/comment.go
//
// Generated by this command:
//
//	mockgen -source=internal/publishing/ports/comment.go -destination=internal/testkit/mocks/mock_publishing_comment.go -package=mocks
//
