...
type HealthHandler struct {
	healthUseCase ports.HealthAssessor
	log           ports.Logger
}

// NewHealthHandler creates a new instance of HealthHandler.
func NewHealthHandler(healthUseCase ports.HealthAssessor, log ports.Logger) *HealthHandler {
...
func newHealthReportResponse(assessment domain.HealthAssessment) dto.HealthReportResponse {
