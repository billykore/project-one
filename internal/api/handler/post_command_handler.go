...
type PostCommandHandler struct {
	postUseCase    ports.PostCommandUseCase
	commentUseCase ports.CommentUseCase
	validator      ports.Validator
	log            ports.Logger
}

func NewPostCommandHandler(postUseCase ports.PostCommandUseCase, commentUseCase ports.CommentUseCase, validator ports.Validator, log ports.Logger) *PostCommandHandler {
