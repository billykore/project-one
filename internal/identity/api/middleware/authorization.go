...
func Authorize(authenticator identityports.Authenticator) echo.MiddlewareFunc {
...
func OptionalAuthorize(authenticator identityports.Authenticator) echo.MiddlewareFunc {
	return func(next echo.HandlerFunc) echo.HandlerFunc {
		return func(c echo.Context) error {
