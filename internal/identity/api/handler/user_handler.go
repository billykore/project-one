...
import (
	...
	socialdomain "github.com/billykore/project-one/internal/social/domain"
...
func toFollowingResponse(f socialdomain.Following) dto.FollowingResponse {
...
func toFollowerResponse(f socialdomain.Follower) dto.FollowerResponse {
