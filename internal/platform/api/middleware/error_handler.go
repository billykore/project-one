...
import (
	...
	"github.com/billykore/project-one/internal/platform/api/dto"
...
func ErrorHandler(log platformports.Logger, errorTypeBaseURL string, withStackTrace bool) func(err error, c echo.Context) {
