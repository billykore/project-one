...
func NewPostQueryHandler(postUseCase publishingports.PostQueryUseCase, commentUseCase publishingports.CommentUseCase, log platformports.Logger) *PostQueryHandler {
