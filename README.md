...
* **User Management**: Consolidated domain endpoints for user authentication (login/logout) and profile data, secured with JWT and Bcrypt. Authentication tokens are securely managed via HttpOnly cookies.
